...
<div class="header-w3l-agile">
		<div class="header_left">
			<ul>
				<li><a href="mailto:info@example.com"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>novi@gmail.com</a></li>
				<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> 087 777 355 355 </li>
			</ul>
		</div>
			...
			<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="<?php echo site_url('index/indexadmin'); ?>" class="hvr-underline-from-center active"> Home </a></li>
							<li><a href="<?php echo site_url('produk/index'); ?>" class="hvr-underline-from-center active"> Data Mobil </a></li>
							<li><a href="<?php echo site_url('customer/customer'); ?>" class="hvr-underline-from-center active"> Data Customer </a></li>
							<li><a href="<?php echo site_url('sewa/sewa'); ?>" class="hvr-underline-from-center active"> Data Sewa </a></li>
							<li><a href="<?php echo site_url('authentication/auth/logout'); ?>" class="hvr-underline-from-center active"> LOGOUT </a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>	
				</nav>
